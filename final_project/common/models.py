...
class CustomUser(AbstractUser):
    ...
    test_sangmin = models.OneToOneField(predict_budget, on_delete=models.CASCADE, related_name='custom_user', blank=True, null=True)
...
class CustomerCardHistory(models.Model):
    id = models.AutoField(primary_key=True)
    seq = models.CharField(max_length=255, blank=True, null=True)
    interior_am = models.DecimalField(max_digits=18, decimal_places=0, blank=True, null=True)
    interior_am = models.DecimalField(max_digits=18, decimal_places=0, blank=True, null=True)
